...
class TorchController:
  ...
  def get_obs(self, model, data) -> np.ndarray:
    ...
    print(f"Obs components shapes: projected_gravity {projected_gravity.shape}, velocity_commands {velocity_commands.shape}, joint_pos {joint_pos_pytorch.shape}, joint_vel {joint_vel_pytorch.shape}, actions {actions_pytorch.shape}")
