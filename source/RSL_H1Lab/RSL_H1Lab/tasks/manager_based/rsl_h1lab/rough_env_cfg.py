...
import H1Lab.tasks.manager_based.h1lab.mdp as mdp
from H1Lab.tasks.manager_based.h1lab.velocity_env_cfg import LocomotionVelocityRoughEnvCfg, RewardsCfg
...
class H1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Terminations
        self.terminations.base_contact.params["sensor_cfg"].body_names = [".*torso_link", ".*elbow_link"]
