...
# # import H1Lab.H1Lab.tasks.manager_based.h1lab.mdp as mdp
# import RSL_H1Lab.tasks.manager_based.rsl_h1lab.mdp as mdp
# from RSL_H1Lab.tasks.manager_based.rsl_h1lab.velocity_env_cfg import LocomotionVelocityRoughEnvCfg, RewardsCfg
...
#         func=mdp.joint_pos_limits, weight=-5.0, params={"asset_cfg": SceneEntityCfg("robot", joint_names=".*_ankle")}
#     )
...
#         func=mdp.joint_deviation_l1, weight=-0.5, params={"asset_cfg": SceneEntityCfg("robot", joint_names="torso")}
#     )
...
#         # self.events.base_external_force_torque.params["preset_force"] = [0.0, 0.0, -50.0]
#         # self.events.base_external_force_torque.params["link_name"] = ".*elbow_link"  # Apply force to the torso link
